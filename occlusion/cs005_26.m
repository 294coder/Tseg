...
X_cover=load('C:/first_3/26咬合接触分布测试集/26_005_cover1.txt');
M_register=[0.727 -0.600 0.333;
            0.525 0.172 -0.834;
            0.443 0.781 0.440;] ;   
X_cover1=(M_register*X_cover.').';
X_cover1(:,1)=X_cover1(:,1)+0.805;
X_cover1(:,2)=X_cover1(:,2)+4.896;
X_cover1(:,3)=X_cover1(:,3)+18.620;
X_cover1=(M*X_cover1.').';
x_cover1=X_cover1(:,1);
y_cover1=X_cover1(:,2);


path1='C:\first_3\26咬合接触分布测试集\cs005-lu\26.txt';
