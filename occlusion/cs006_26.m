...
X_cover=load('C:/first_3/26咬合接触分布测试集/26_006_cover1.txt');
M_register=[0.768 -0.493 0.408;
            0.567 0.228 -0.792;
            0.298 0.839 0.455;] ;   
X_cover1=(M_register*X_cover.').';
X_cover1(:,1)=X_cover1(:,1)+2.244;
X_cover1(:,2)=X_cover1(:,2)+3.609;
X_cover1(:,3)=X_cover1(:,3)+21.820;
X_cover1=(M*X_cover1.').';
x_cover1=X_cover1(:,1);
y_cover1=X_cover1(:,2);


path1='C:\first_3\26咬合接触分布测试集\cs006-lu\26.txt';
